...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--input-video', type=str,
                             default='/home/wc/wc/dataset/videos/MOT16-03.mp4',
                             help='path to the input video')
    self.parser.add_argument('--output-format', type=str, default='video', help='video or text')
    self.parser.add_argument('--output-root', type=str, default='/home/wc/wc/dataset/videos/demos', help='expected output root path')

    # mot
    self.parser.add_argument('--data_cfg', type=str,
                             default='/home/wc/wc/UniMOT/detection/fairmot/src/lib/cfg/data.json',#../src/lib/cfg/data.json
                             help='load data from cfg')
    self.parser.add_argument('--data_dir', type=str, default='/home/wc/wc/dataset/dataset')
