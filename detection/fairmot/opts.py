...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--task', default='mot', help='mot')#'mot'
    self.parser.add_argument('--dataset', default='jde', help='jde')
    self.parser.add_argument('--exp_id', default='default')
    self.parser.add_argument('--test', action='store_true')
    #self.parser.add_argument('--load_model', default='../models/ctdet_coco_dla_2x.pth',
                             #help='path to pretrained model')
    self.parser.add_argument('--load_model', default='/home/lpj/wc/FairMOT-master/models/ctdet_coco_dla_2x.pth',
                             help='path to pretrained model')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/home/lpj/wc/dataset')#zyf/dataset
