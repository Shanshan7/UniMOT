...
import numpy as np
from tracker.fairmot.basetrack import TrackState
from tracker.fairmot.stracker import STrack
from tracker.fairmot import matching
from tracker.fairmot.kalman_filter import KalmanFilter


class JDETracker(BaseTrack):
